...
- **Current architecture guide**: [ARCHITECTURE_PROPOSAL.md](./ARCHITECTURE_PROPOSAL.md) defines the recommended backend structure for TrackFlow's logistics business model.
